#!/usr/bin/env python3
"""build_web_v3.py -- v2 packing + AI panel data (POD+LSTM rollout, phase check,
error-type fingerprint vs RHSIA) -> web/shear_drift_explorer_v3.html.
...
html = open("web/explorer_template_v3.html").read()
...
open("web/shear_drift_explorer_v3.html", "w").write(html)
print(f"web/shear_drift_explorer_v3.html  {len(html)/1e6:.1f} MB")
