#!/usr/bin/env python3
"""build_web_v4.py -- v3 + error-type table (law_vs_errortype.py) + researcher quotes (POD+LSTM rollout, phase check,
error-type fingerprint vs RHSIA) -> web/shear_drift_explorer_v4.html.
...
html = open("web/explorer_template_v4.html").read()
...
open("web/shear_drift_explorer_v4.html", "w").write(html)
print(f"web/shear_drift_explorer_v4.html  {len(html)/1e6:.1f} MB")
