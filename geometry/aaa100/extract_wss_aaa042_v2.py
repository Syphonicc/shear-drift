...
Reads the last cycle (t=3.6 to 4.5, 40 samples) from case_aaa042_v4_result/.
"""
import numpy as np
import pyvista as pv
from pathlib import Path

CASE = Path(__file__).parent / "case_aaa042_v4_result"
...
out = CASE.parent / "wss_data_aaa042_v4.npz"
