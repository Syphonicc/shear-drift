"""Extract wallShearStress for the LAST TWO cardiac cycles of AAA042 v4 (t=2.7225
to 4.5, 80 samples) so mechanism_test.py (needs 2 cycles for its detune window)
can run on real AAA042 data, mirroring the cerebral-case drift-injection analysis.
"""
import numpy as np
import pyvista as pv
from pathlib import Path

CASE = Path(__file__).parent / "case_aaa042_v4_result2"
...
times = [t for t in reader.time_values if t > 2.7 + 1e-9 and t <= 4.5 + 1e-9]
...
out = CASE.parent / "wss_data_aaa042_v4_2cyc.npz"
