...
def main():
    ...
    np.savez_compressed('mechanism_test_aaa042_v2.npz',
    ...
    try:
        ...
        plt.tight_layout(); plt.savefig('mechanism_test_aaa042_v2.png', dpi=140)
        print('\nwrote mechanism_test_aaa042_v2.png and mechanism_test_aaa042_v2.npz')
