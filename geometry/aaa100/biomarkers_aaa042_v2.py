"""TAWSS / OSI / RRT for AAA042 v4 (successful 5-cycle run), same cancellation-law
...
d = np.load(ROOT / "wss_data_aaa042_v4.npz")
...
np.savez_compressed(ROOT / "biomarkers_aaa042_v4_lastcycle.npz", tawss=tawss, osi=osi, rrt=rrt, areas=areas)
